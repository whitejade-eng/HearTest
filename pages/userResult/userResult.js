// pages/userResult/userResult.js
...
Page({
  ...
  data: {
    userScore:0,
    userAccuracyResult:{"m":0,"s":0,"x":0,"sh":0,"u":0,"i":0,"a":0},//每个音节正确率
    u:{},
    ec: {
      onInit: initChart
    },
  ...
  onLoad(options) {
    ...
    //计算userAccuracyResult    
      var u_AR = this.Cal_userAccuracyResult(userAccuracy);
      this.setData({
  ...
  //计算userAccuracyResult
  Cal_userAccuracyResult:function(userAccuracy){
   var that = this;
